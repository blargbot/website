  ...
  <div>
    <section>
      <div class="child card shadow-2">
        <h1>Donations</h1>
        <span>blargbot is free.</span>
        <p>
          I do not and will not charge money for any of blargbot's
          functionality. However, running it is most definitely not free. I put
        ...
        <div class="button-grid">
          ...
          <a href="https://paypal.me/stupidcat" class="child-1 button shadow-2">Paypal</a>
        </div>
        <p v-twemoji>
